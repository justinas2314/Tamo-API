...
def namu_darbai(session, parser, nuo_data, iki_data, dalyko_id, metodas = 0):
    """
    ...
    if nuo_data is None or iki_data is None:
        ...
        soup = bs4.BeautifulSoup(post_req(session, "https://dienynas.tamo.lt/Darbai/NamuDarbai",
                                          data={
                                              "DateFilterMode": metodas,  # Date filter mode, tai nustato kaip ziurimos datos (0 - atlikimo data, 1 - pamokos data)
                                              "DataNuo": nuo_data,
                                              "DataIki": iki_data,
